...
//  */
// export const pick = (object: any, fields: string[]) => {
// 	const obj = {};
 ...
 */
export const filterOutSelectedValues = (data: any, values: any): object => {
	if (!data) {
		return {};
	}
 ...
 * @return {*}
 */
export const formatString = (str: string, data?: any): string => {
	if (!str || !data) {
		return str;
	}
